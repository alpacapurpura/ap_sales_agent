...
from src.core.security import encrypt_string, decrypt_string, get_encryption_key
...
class EncryptedJSON(TypeDecorator):
    ...
    def process_bind_param(self, value: Optional[Union[Dict, list]], dialect) -> Optional[Dict]:
        if value is None:
            return None
    ...
    def process_result_value(self, value: Optional[Any], dialect) -> Optional[Union[Dict, list]]:
        if value is None:
            return None
