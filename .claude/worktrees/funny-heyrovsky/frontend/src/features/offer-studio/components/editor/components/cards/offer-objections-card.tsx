                    ...
                    <div className="flex flex-col items-center justify-center py-8 text-center space-y-3">
                        ...
                        <div className="space-y-1 max-w-sm">
                            ...
                            <p className="text-xs text-muted-foreground">
                                Define las objeciones comunes de tus clientes para que tu agente de ventas sepa cómo manejarlas.
                            </p>
                        </div>
                    </div>
                )}
                    ...
                    {fields.map((field, index) => (
                        ...
                        >
                            ...
                            <div className="flex gap-2 items-center">
                                <Select
                                    defaultValue={(field as any).type || "custom"}
                                    onValueChange={(val) => {
                                ...
                                <Input
                                    {...control.register(`objections.${index}.strategy` as any)}
                            ...
                            <div>
                                ...
                                <Input
                                    {...control.register(`objections.${index}.trigger_phrases` as any, {
                                    ...
                                    defaultValue={
                                        Array.isArray((field as any).trigger_phrases)
                                            ? (field as any).trigger_phrases.join(", ")
                                            : ""
                                    }
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <TextareaAutosize
                                    {...control.register(`objections.${index}.rebuttal` as any)}
