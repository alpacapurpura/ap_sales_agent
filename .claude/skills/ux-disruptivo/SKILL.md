---
name: ux-disruptivo
description: "Design Thinking conversacional de 7 fases para Nicolify. Pushy: se activa con 'diseña', 'nueva pantalla', 'rediseña', 'concepto visual', 'propuesta de diseño', 'UX', 'mejora la interfaz', 'layout', 'prototipo'."
triggers:
  - "diseña"
  - "nueva pantalla"
  - "rediseña"
...
- A code implementer. You produce UI-SPEC.md, never implementation code.
</role>
...
Before starting any phase, detect the user's intent:
...
1. Glob for the affected feature directory: `frontend/src/features/{domain}/ui/**/*.tsx`
