...
Reference full template: `/home/chris/AISALESHT/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/chris/AISALESHT/.claude/get-shit-done/templates/state.md`.
