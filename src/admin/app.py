...
from src.services.models import AgentTrace, Message, PromptVersion
...
def render_audit_view():
    ...
    try:
        ...
        if st.button("🗑️ Borrar Historial de este Usuario"):
            repo.clear_user_conversation(user_id)
...
with st.sidebar:
    ...
    menu_selection = st.radio(
        "Navegación",
        ["Dashboard", "Cargar Documentos", "Carga Masiva", "Inventario", "Probador RAG", "Gestión de Prompts", "Auditoría", "Configuración"],
...
with main_container.container():
    if menu_selection == "Dashboard": render_dashboard()
    elif menu_selection == "Cargar Documentos": render_upload_view()
    elif menu_selection == "Carga Masiva": render_bulk_upload_view()
    elif menu_selection == "Inventario": render_inventory_view()
    elif menu_selection == "Probador RAG": render_rag_tester()
    elif menu_selection == "Gestión de Prompts": render_prompt_manager()
    elif menu_selection == "Auditoría": render_audit_view()
    elif menu_selection == "Configuración": render_settings_view()
