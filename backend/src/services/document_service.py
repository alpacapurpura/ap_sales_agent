...
from src.services.db.models.business import Document
...
class DocumentService:
                ...
                for p in points:
                    ...
                    if source not in unique_docs:
                        ...
                        unique_docs[source] = {
                            ...
                            "marketing_asset_id": payload.get("marketing_asset_id")
                        }
                ...
                if not exists:
                    try:
                        new_doc = Document(
                            ...
                            marketing_asset_id=info.get("marketing_asset_id")
                        )
                        db.add(new_doc)
                        stats["created"] += 1
    ...
    def create_document(
        ...
        marketing_asset_id: Optional[uuid.UUID] = None
    ) -> Document:
        db: Session = SessionLocal()
        try:
            doc = Document(
