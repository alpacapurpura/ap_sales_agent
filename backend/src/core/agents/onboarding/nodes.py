import re
import json
from src.core.agents.onboarding.state import OnboardingState
from src.core.agents.onboarding.prompts import JANITOR_PROMPT, PSYCHOLOGIST_PROMPT, ARCHITECT_PROMPT, SIMULATOR_PROMPT
