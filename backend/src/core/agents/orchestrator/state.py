...
from src.core.domain.schema import FunnelStage, ProductLaunchStage
...
class AgentState(TypedDict):
    ...
    critique_count: int # Number of times the response has been revised (0 = first draft)
    critique_reasoning: Optional[str] # Feedback from the Critic node
    is_revision: bool # Flag to indicate if we are in a revision loop
