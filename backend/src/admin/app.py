...
PAGE_SPECS: tuple[PageSpec, ...] = (
    ...
    PageSpec(slug="marketing-kb", title="Marketing KB (curado)", icon="📚"),
    ...
    PageSpec(slug="sales-routing", title="Routing del Sales Agent", icon="🧭"),
    ...
    PageSpec(slug="copilot-limits", title="Límites de Copilot", icon="🔒"),
    ...
    PageSpec(slug="llm-models", title="LLM Model Registry", icon="🤖"),
)
