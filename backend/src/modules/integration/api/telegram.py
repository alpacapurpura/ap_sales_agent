...
from src.modules.communication.api.dto.telegram import TelegramConnectRequest, ChannelStatusResponse
from src.modules.integration.infrastructure.channels.telegram_service import TelegramService
...
@router.get("/channels/telegram", response_model=ChannelStatusResponse)
...
@router.delete("/channels/telegram")
