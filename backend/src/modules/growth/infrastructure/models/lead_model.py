...
class LeadModel(Base):
    ...
    tenant = relationship("src.modules.iam.infrastructure.models.tenant_model.TenantModel", back_populates="leads")
    
    # Relationships
    # appointments = relationship("src.modules.communication.infrastructure.models.appointment.Appointment", back_populates="lead", cascade="all, delete-orphan")
    # messages = relationship("src.modules.communication.infrastructure.models.message.Message", back_populates="lead", cascade="all, delete-orphan")
