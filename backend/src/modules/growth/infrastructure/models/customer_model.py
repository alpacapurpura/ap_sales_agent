...
from src.modules.marketing.domain.enums import LifecycleStage, IdentityType
...
class CustomerProfileModel(Base):
    ...
    # Relationships
    identities = relationship("CustomerIdentityModel", back_populates="profile", cascade="all, delete-orphan")
    journey_events = relationship("JourneyEventModel", back_populates="profile", cascade="all, delete-orphan")
