...
BRAND_SETUP = Procedure(
    ...
    steps=[
        ProcedureStep(
            ...
            module_id="brand",
            section_id="identity",
            instruction="Completa la identidad básica de tu marca: nombre, eslogan, misión, visión y valores.",
            validation="has_required_fields",
            tips=[
                "Si tienes un sitio web, puedo extraer esta información automáticamente",
                "Empieza por el nombre y eslogan — lo demás fluye desde ahí",
            ],
        ...
        ProcedureStep(
            ...
            module_id="brand",
            section_id="story",
            instruction="Cuenta la historia de tu marca: origen, propósito y momentos clave.",
            validation="has_required_fields",
            tips=[
                "Una buena historia de marca conecta emocionalmente con tu audiencia",
                "Piensa en qué problema te motivó a crear tu negocio",
            ],
            route_hint="brand-settings",
        ),
        ProcedureStep(
            ...
            validation="has_required_fields",
            tips=[
                "El posicionamiento responde: ¿por qué alguien te elegiría sobre la competencia?",
                "Puedo ayudarte a construir tu UVP basándome en tu identidad",
            ],
            route_hint="brand-settings",
        ),
        ProcedureStep(
            ...
            instruction="Construye tu narrativa con el framework StoryBrand: héroe, problema, guía y plan.",
            validation="has_required_fields",
            tips=[
                "En StoryBrand, tu cliente es el héroe, tú eres el guía",
                "El 'problema' tiene 3 niveles: externo, interno y filosófico",
            ],
            route_hint="brand-settings",
        ),
        ProcedureStep(
            ...
            module_id="brand",
            section_id="visuals",
            instruction="Configura tu identidad visual: colores, tipografías, logo y estilo fotográfico.",
            validation="has_required_fields",
            tips=[
                "Si tienes un sitio web, puedo extraer colores y tipografías automáticamente",
        ...
        ProcedureStep(
            ...
            instruction="Crea tus assets de comunicación: voz de marca, tono, mensajes clave y pilares de contenido.",
            validation="has_required_fields",
            tips=[
