...
from src.modules.marketing.application.services.customer_service import CustomerService
from src.modules.marketing.domain.customer import CustomerProfile
