...
from src.modules.scheduling.domain.availability_schema import AvailabilitySchedule, WeeklySchedule, DaySchedule, TimeRange, ScheduleUpdate
    ...
    def list_schedules(self) -> List[AvailabilitySchedule]:
        ...
        for s in schedules_data:
            try:
                ...
                logger.error(f"Failed to migrate schedule {s.get('id', 'unknown')}: {e}")
