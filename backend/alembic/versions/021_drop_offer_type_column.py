...
def upgrade():
    # 1. Backfill archetype where NULL (defensive)
    op.execute("""
    ...
    # 4. Make archetype NOT NULL
    op.execute("ALTER TABLE products ALTER COLUMN archetype SET NOT NULL")
...
def downgrade():
    ...
    op.execute("ALTER TABLE products ALTER COLUMN type SET NOT NULL")
    op.execute("ALTER TABLE products ALTER COLUMN archetype DROP NOT NULL")
