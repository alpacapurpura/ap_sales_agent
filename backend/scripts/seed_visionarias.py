...
from src.core.domain.lead_enums import AvatarPersona, FinancialCapacity, LeadTemperature
    ...
    try:
        ...
        for p in products:
            ...
            if not p.headline_promise:
                p.headline_promise = (
                    "Estructura, Lanza y Escala tu Negocio Digital High Ticket en 90 días sin sacrificar tu vida."
                )
