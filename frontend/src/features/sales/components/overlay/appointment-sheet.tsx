      ...
      <SheetContent>
        ...
        <div className="mt-6 space-y-6">
            ...
            <div className="bg-muted/30 p-4 rounded-md space-y-3">
              ...
              {appointment.meet_link && (
                <div className="flex items-center gap-3">
                  ...
                  <a href={appointment.meet_link} target="_blank" rel="noreferrer" className="text-sm text-blue-600 hover:underline truncate">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              {appointment.attendees && appointment.attendees.map((email: string) => (
        ...
        <SheetFooter className="mt-8 flex-col sm:flex-col gap-2">
           ...
           <div className="flex gap-2 w-full">
             <Button className="flex-1" variant="outline">Reprogramar</Button>
