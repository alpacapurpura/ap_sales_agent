    ...
    if (open) {
        if (initialData) {
            ...
            setFormData({
                ...
                duration: 30,
                slug: "",
                availability_id: availabilities.find(a => a.is_default)?.id || (availabilities[0]?.id) || null,
                scheduling_limits: { max_advance_days: 60, min_advance_hours: 4 },
                booking_config: { buffer_minutes: 30, max_per_day: null, guest_permissions: true },
                calendar_id: null,
                confirmation_button: { enabled: false, text: "Volver al inicio", url: "" }
    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent className="sm:max-w-xl w-full overflow-y-auto">
        <SheetHeader>
          ...
          <SheetDescription>
            Configura los detalles de este evento.
          </SheetDescription>
        </SheetHeader>
        ...
        <div className="mt-6 space-y-6 pb-20">
                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="grid gap-2">
                        ...
                        <Select 
                            ...
                            onValueChange={(v) => setFormData({...formData, availability_id: v === "default" ? null : v})}
                        >
            ...
            <div className="space-y-4">
                <h4 className="font-medium text-sm text-muted-foreground uppercase">Plazo para programar</h4>
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div className="grid gap-2">
                        ...
                        <Input 
                            ...
                            onChange={(e) => updateSchedulingLimit('max_advance_days', parseInt(e.target.value))}
                        />
                    </div>
                    <div className="grid gap-2">
                        ...
                        <Input 
                            ...
                            onChange={(e) => updateSchedulingLimit('min_advance_hours', parseInt(e.target.value))}
                        />
                    </div>
                </div>
            </div>
            ...
            <div className="space-y-4">
                <h4 className="font-medium text-sm text-muted-foreground uppercase">Configuración de Reserva</h4>
                
                <div className="flex items-center justify-between border p-3 rounded-md">
                    <div className="space-y-0.5">
                        <Label>Buffer (Margen entre citas)</Label>
                        <p className="text-xs text-muted-foreground">Minutos de descanso después de cada cita</p>
                    </div>
                    <div className="flex items-center gap-2">
                        <Input 
                            className="w-20 h-8" 
                ...
                <div className="flex items-center justify-between border p-3 rounded-md">
                     <div className="space-y-0.5">
                        ...
                        <p className="text-xs text-muted-foreground">Los invitados pueden invitar a otros</p>
                    </div>
                    <Checkbox 
            ...
            <div className="space-y-2">
                ...
                <Select disabled value="primary">
                    <SelectTrigger><SelectValue placeholder="Google Calendar (Principal)" /></SelectTrigger>
                    <SelectContent>
                        <SelectItem value="primary">Google Calendar (Principal)</SelectItem>
                    </SelectContent>
                </Select>
                <p className="text-xs text-muted-foreground">Por ahora solo se soporta el calendario principal conectado.</p>
            </div>

            <Separator />

            <div className="space-y-4">
                <h4 className="font-medium text-sm text-muted-foreground uppercase">Botón de Confirmación</h4>
                
                <div className="flex items-center justify-between border p-3 rounded-md bg-muted/20">
                    <div className="space-y-0.5">
                        <Label>Redirección Personalizada</Label>
                        <p className="text-xs text-muted-foreground">Muestra un botón en la página de éxito.</p>
                    </div>
                    <Checkbox 
