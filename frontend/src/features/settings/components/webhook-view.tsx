      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            ...
            Utiliza estos credenciales para enviar mensajes y recibir respuestas del &quot;Cerebro&quot;.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2">
              ...
              <Dialog open={confirmOpen} onOpenChange={setConfirmOpen}>
                ...
                <DialogContent>
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Esta acción invalidará la clave actual inmediatamente. Cualquier integración activa (n8n, ManyChat) dejará de funcionar hasta que actualices la clave.
                    </DialogDescription>
                  </DialogHeader>
                  <DialogFooter>
            ...
            <p className="text-xs text-muted-foreground">
              Esta clave debe enviarse en el Header <code>X-Webhook-Secret</code>. Nunca la compartas públicamente.
            </p>
          </div>
          ...
          {!settings?.webhook_secret && (
            <Alert variant="destructive" className="bg-white">
              ...
              <AlertDescription>
                Aún no tienes un Secret Key generado. Haz clic en el botón de regenerar para activar el acceso externo.
              </AlertDescription>
            </Alert>
          )}
     ...
     "name": "{{ $json.name }}"
        ...
        <TabsContent value="manychat">
          <Card>
            ...
            <CardContent className="space-y-4 text-sm">
              <p>Usa la acción <strong>External Request</strong> en tu flujo:</p>
              <ul className="list-disc pl-5 space-y-2">
                <li><strong>Request Type:</strong> POST</li>
                <li><strong>Request URL:</strong> Copia la URL de arriba.</li>
                <li><strong>Headers:</strong> Agrega <code>X-Webhook-Secret</code> con tu clave.</li>
...
{`{
  ...
  "metadata": {
    ...
    "phone": "{{ phone }}"
                ...
                <li><strong>Response Mapping:</strong> Mapea <code>$.response</code> a un Custom Field (ej. <code>bot_response</code>).</li>
              </ul>
            </CardContent>
          </Card>
        </TabsContent>
