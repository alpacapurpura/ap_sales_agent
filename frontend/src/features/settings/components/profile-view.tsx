    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Información personal gestionada por tu proveedor de autenticación.
          </CardDescription>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Contexto que utiliza la IA para personalizar tu experiencia.
          </CardDescription>
        </CardHeader>
        <CardContent className="grid gap-6 md:grid-cols-2">
          <div className="space-y-2">
            ...
            <div className="p-3 bg-muted/50 rounded-md text-sm font-medium border">{timeZone}</div>
            <p className="text-[0.8rem] text-muted-foreground">
              Detectada automáticamente de tu sistema.
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="p-3 bg-muted/50 rounded-md text-sm font-medium border">Español</div>
            <p className="text-[0.8rem] text-muted-foreground">
          ...
          <div className="space-y-2 md:col-span-2">
            ...
            <p className="text-[0.8rem] text-muted-foreground">
              Identificador único para soporte técnico.
            </p>
          </div>
        </CardContent>
      </Card>
