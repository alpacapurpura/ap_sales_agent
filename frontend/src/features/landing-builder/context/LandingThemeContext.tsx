...
import { LandingPageTheme } from '@/features/landing-builder/types/schema';

const LandingThemeContext = createContext<LandingPageTheme | null>(null);

export function LandingThemeProvider({ children, theme }: { children: React.ReactNode, theme: LandingPageTheme }) {
    return (
