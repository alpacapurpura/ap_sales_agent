...
export function AiRemixButton({ offerId }: AiRemixButtonProps) {
    ...
    const selectedItem = itemSelector ? appState.data.content.find(item => item.props.id === itemSelector.index) : null;
    ...
    const handleRemix = async () => {
        ...
        try {
            ...
            // Call Backend
            const newProps = await offerApi.regenerateBlock(offerId, selectedBlock.type, selectedBlock.props, instruction, token);
        ...
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Da instrucciones para mejorar esta sección. La IA usará el contexto de tu marca y oferta.
                    </DialogDescription>
                </DialogHeader>
                <div className="py-4">
                    <Textarea 
                ...
                <DialogFooter>
                    ...
                    <Button onClick={handleRemix} disabled={isLoading} className="bg-indigo-600 hover:bg-indigo-700">
