...
import { ImageGalleryPicker } from "../shared/image-gallery-picker";
...
export function TeamMemberForm({ initialData, onSave, isSaving = false, embedded = false }: TeamMemberFormProps) {
            ...
            <div className="space-y-4">
                ...
                <div className="p-4 border rounded-lg bg-muted/5 space-y-4">
                     <div className="flex items-center gap-4">
                        <div className="h-16 w-16 rounded-full overflow-hidden bg-background border-2 border-primary/20 flex-shrink-0 shadow-sm">
                            {currentMember.headshot_url ? (
                                // eslint-disable-next-line @next/next/no-img-element
                                <img 
                                    src={currentMember.headshot_url.startsWith("http") ? currentMember.headshot_url : `${apiUrl}${currentMember.headshot_url}`} 
                                    alt="Active Profile" 
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-xs text-muted-foreground">Esta es la imagen que se mostrará en las tarjetas.</p>
                        </div>
                    </div>
    ...
    return (
        <Card>
            <CardHeader>
                <CardTitle>Editar Miembro del Equipo</CardTitle>
            </CardHeader>
            <CardContent>
                <form onSubmit={handleSubmit} className="space-y-6">
                    {FormContent}
