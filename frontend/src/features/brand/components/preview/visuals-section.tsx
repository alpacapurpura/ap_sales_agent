         ...
         <div className="flex flex-col items-center justify-center py-10 text-center border-2 border-dashed rounded-xl bg-muted/20 hover:bg-muted/30 transition-colors">
            ...
            <div className="flex flex-col gap-3 w-full max-w-xs">
                ...
                <Button 
                    ...
                    onClick={(e) => {
                         // Let it bubble to section onClick which calls onEdit
                         // But for clarity we can stop prop and call explicitly if we wanted distinct behavior
                         // Here we want "Manual" -> Sidebar, which is onEdit.
                         // So bubbling is fine, but to be safe/explicit:
                         e.stopPropagation();
                         onEdit();
                    }}
                >
                    ...
                    <div className="flex flex-wrap gap-6 items-end">
                        {visuals.logos?.primary && (
                            <div className="space-y-2">
                                <div className="h-20 px-4 py-2 border rounded-lg bg-[url('/checkerboard.png')] bg-white flex items-center justify-center min-w-[140px]">
                                    {/* eslint-disable-next-line @next/next/no-img-element */}
                                    <img src={getFullUrl(visuals.logos.primary)} alt="Principal" className="max-h-full max-w-full object-contain" />
                                </div>
                        ...
                        {visuals.logos?.secondary && (
                            <div className="space-y-2">
                                <div className="h-20 w-20 p-2 border rounded-lg bg-muted/20 flex items-center justify-center">
                                    {/* eslint-disable-next-line @next/next/no-img-element */}
                                    <img src={getFullUrl(visuals.logos.secondary)} alt="Icono" className="max-h-full max-w-full object-contain" />
                                </div>
                        ...
                        {visuals.logos?.dark_mode && (
                            <div className="space-y-2">
                                <div className="h-20 px-4 py-2 border rounded-lg bg-slate-950 flex items-center justify-center min-w-[140px]">
                                    {/* eslint-disable-next-line @next/next/no-img-element */}
                                    <img src={getFullUrl(visuals.logos.dark_mode)} alt="Dark Mode" className="max-h-full max-w-full object-contain" />
                                </div>
                        ...
                        {visuals.logos?.light_mode && (
                            <div className="space-y-2">
                                <div className="h-20 px-4 py-2 border rounded-lg bg-white flex items-center justify-center min-w-[140px]">
                                    {/* eslint-disable-next-line @next/next/no-img-element */}
                                    <img src={getFullUrl(visuals.logos.light_mode)} alt="Light Mode" className="max-h-full max-w-full object-contain" />
                                </div>
