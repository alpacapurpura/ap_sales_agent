...
type VisualsSchema = z.infer<typeof formSchema>;
function ColorInput({
  label,
  name,
  desc,
...
export function VisualsForm({ initialData, onSave, isSaving }: VisualsFormProps) {
  ...
  // --- List helpers ---
  const addToList = (
    field: "usage_guidelines" | "color_palette" | "neutral_colors" | "gradient_definitions",
    defaultVal = "",
  ) => {
              ...
              <div className="space-y-6 pl-3 border-l-2 border-muted ml-1.5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <ColorInput
                    label="Primario"
                    name="primary_color"
                    desc="Color principal de marca."
                    control={form.control}
                  />
                  <ColorInput
                    label="Secundario"
                    name="secondary_color"
                    desc="2do color de marca."
                    control={form.control}
                  />
                  <ColorInput
                    label="Acento"
                    name="accent_color"
                    desc="Highlights y CTAs."
                    control={form.control}
                  />
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <ColorInput
                    ...
                    desc="Fondo principal."
                    control={form.control}
                  />
                  <ColorInput
                    label="Superficie"
                    name="surface_color"
                    desc="Cards y modales."
                    control={form.control}
                  />
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <ColorInput
                    ...
                    desc="Texto en botones primarios."
                    control={form.control}
                  />
                  <ColorInput
                    label="Texto sobre Secundario"
                    name="text_on_secondary"
                    desc="Texto sobre secondary."
                    control={form.control}
                  />
                </div>
                ...
                <CollapsibleSection title="Paleta Extendida">
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      <Label className="text-xs text-muted-foreground">
                        Colores adicionales de marca (HEX)
                      </Label>
                      <Button
                        type="button"
                        variant="outline"
                        size="sm"
                        onClick={() => addToList("color_palette", "#")}
                    ...
                    <div className="flex flex-wrap gap-2">
                      {colorPalette.map((color, i) => (
                        <div key={i} className="flex items-center gap-1 border rounded-md p-1">
                          ...
                          <button
                            type="button"
                            onClick={() => removeFromList("color_palette", i)}
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      <Label className="text-xs text-muted-foreground">
                        Neutros (grises, borders)
                      </Label>
                      <Button
                        type="button"
                        variant="outline"
                        size="sm"
                        onClick={() => addToList("neutral_colors", "#")}
                        className="h-7 text-xs"
                      >
                    ...
                    <div className="flex flex-wrap gap-2">
                      {neutralColors.map((color, i) => (
                        <div key={i} className="flex items-center gap-1 border rounded-md p-1">
                          ...
                          <button
                            type="button"
                            onClick={() => removeFromList("neutral_colors", i)}
                            className="text-muted-foreground hover:text-destructive"
                          >
                            <Trash2 className="w-3 h-3" />
                          </button>
                ...
                <CollapsibleSection title="Gradientes">
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      <Label className="text-xs text-muted-foreground">
                        Definiciones CSS de gradientes
                      </Label>
                      <Button
                        type="button"
                        variant="outline"
                        size="sm"
                        onClick={() => addToList("gradient_definitions")}
                        className="h-7 text-xs"
                      >
                    ...
                    {gradients.map((grad, i) => (
                      <div key={i} className="flex gap-2 items-start group">
                        <div
                          className="w-12 h-8 rounded border shrink-0"
                        ...
                        <button
                          type="button"
                          onClick={() => removeFromList("gradient_definitions", i)}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea
                          placeholder="Ej: 60% fondo blanco, 30% purpura en headers, 10% naranja en CTAs..."
                          {...field}
                          value={field.value || ""}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            placeholder="Font display/accent..."
                            {...field}
                            value={field.value || ""}
                          />
                        </FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea
                          placeholder="Ej: Similar a Apple en minimalismo + Stripe en gradientes..."
                          {...field}
                          value={field.value || ""}
                          className="min-h-[3rem] text-sm"
                        />
