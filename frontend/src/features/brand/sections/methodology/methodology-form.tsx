    ...
    <form onSubmit={handleSubmit} className="space-y-8">
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <WithCopilot
            fieldId="methodology_name"
            fieldLabel="Nombre de Metodología"
            getValue={() => strategy.methodology_name || ""}
          >
            <Input
              id="methodology_name"
          ...
          <p className="text-xs text-muted-foreground">
            Ponle nombre a tu proceso para aumentar su valor percibido.
          </p>
        </div>
        ...
        <div className="space-y-2">
          ...
          <WithCopilot
            fieldId="methodology_description"
            fieldLabel="Descripción de Metodología"
            getValue={() => strategy.methodology_description || ""}
          >
            <Textarea
              id="methodology_description"
              value={strategy.methodology_description || ""}
              onChange={(e) =>
                setStrategy({ ...strategy, methodology_description: e.target.value })
              }
