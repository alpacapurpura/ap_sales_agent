        ...
        <div className="pl-0 md:pl-14">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredImages.map((img) => (
              <div
                key={img.id}
                className="group/card relative bg-card rounded-xl border border-border overflow-hidden shadow-sm hover:shadow-md transition-all"
              >
                <div
            ...
            <div
              className="flex flex-col items-center justify-center text-center group/add cursor-pointer min-h-[200px] border-2 border-dashed border-muted-foreground/20 rounded-lg hover:border-primary/50 hover:bg-primary/5 transition-colors"
              onClick={() => setIsUploadOpen(true)}
            >
