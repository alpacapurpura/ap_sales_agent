...
const COMMON_ASSET_TYPES = ["reel", "carousel", "email", "blog", "webinar", "caso_exito", "landing"];
...
export function AssetItemForm({ asset, concepts, customTypes, onSave, onCancel, isSaving }: AssetItemFormProps) {
                ...
                {concepts.length > 0 && (
                    <div className="grid grid-cols-4 items-center gap-4">
                        ...
                        <Select
                            ...
                            onValueChange={(val) => setCurrent({ ...current, concept_id: val === "_none" ? undefined : val })}
                        >
                            <SelectTrigger className="col-span-3">
