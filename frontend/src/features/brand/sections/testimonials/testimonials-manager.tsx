  ...
  return (
    <div className="space-y-8">
      <Card className="w-full min-h-[600px]">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-6">
          <div className="space-y-1">
            ...
            <CardDescription className="mt-1.5">
              Lo que dicen tus clientes para generar confianza.
            </CardDescription>
          </div>
        ...
        <CardContent>
          <TestimonialsList items={items} onEdit={handleOpenModal} onDelete={handleDelete} />
        </CardContent>
      </Card>
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        <DialogContent className="sm:max-w-[600px]">
          <DialogHeader>
            <DialogTitle>
              {currentItem?.author_name ? "Editar Testimonio" : "Nuevo Testimonio"}
            </DialogTitle>
          </DialogHeader>
          {currentItem && (
            <TestimonialItemForm
