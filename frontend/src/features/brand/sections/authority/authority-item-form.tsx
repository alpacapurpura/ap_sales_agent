...
export function AuthorityItemForm({
  initialData,
  onSave,
  onCancel,
  isSaving = false,
}: AuthorityItemFormProps) {
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="grid gap-4 py-4">
        <div className="grid grid-cols-4 items-center gap-4">
          ...
          <WithCopilot
            fieldId="authority_entity"
            fieldLabel="Entidad de Autoridad"
            getValue={() => currentItem.entity_name || ""}
          >
            <Input
        ...
        <div className="grid grid-cols-4 items-center gap-4">
          ...
          <WithCopilot
            fieldId="authority_context"
            fieldLabel="Contexto de Autoridad"
            getValue={() => currentItem.context || ""}
          >
            <Input
