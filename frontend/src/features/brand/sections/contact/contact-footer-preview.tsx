...
export function FooterSection({ contact, identity, visuals, onEditContact, onEditLegal }: ContactFooterSectionProps) {
          ...
          <div className="space-y-4 relative group">
              ...
              <div className="pt-4 flex flex-wrap gap-2">
                  {contact.social_instagram && (
                      <a href={contact.social_instagram} target="_blank" rel="noreferrer" className="p-2 bg-white/10 rounded-full hover:bg-white/20 transition-colors">
                          <Instagram className="w-4 h-4" />
                      </a>
                  )}
                  {contact.social_linkedin && (
                      <a href={contact.social_linkedin} target="_blank" rel="noreferrer" className="p-2 bg-white/10 rounded-full hover:bg-white/20 transition-colors">
                          <Linkedin className="w-4 h-4" />
                      </a>
                  )}
                   {contact.social_youtube && (
                      <a href={contact.social_youtube} target="_blank" rel="noreferrer" className="p-2 bg-white/10 rounded-full hover:bg-white/20 transition-colors">
                          <Youtube className="w-4 h-4" />
                      </a>
                  )}
                  {contact.social_tiktok && (
                      <a href={contact.social_tiktok} target="_blank" rel="noreferrer" className="p-2 bg-white/10 rounded-full hover:bg-white/20 transition-colors">
                          <Video className="w-4 h-4" />
                      </a>
                  )}
                  {contact.social_facebook && (
                      <a href={contact.social_facebook} target="_blank" rel="noreferrer" className="p-2 bg-white/10 rounded-full hover:bg-white/20 transition-colors">
                          <Facebook className="w-4 h-4" />
                      </a>
                  )}
                  {contact.social_twitter && (
                      <a href={contact.social_twitter} target="_blank" rel="noreferrer" className="p-2 bg-white/10 rounded-full hover:bg-white/20 transition-colors">
           ...
           <div id="legal" className="space-y-4 relative group">
              ...
              <ul className="space-y-3 text-sm opacity-90">
                  ...
                  {identity.fiscal_address && (
                      <li className="flex flex-col gap-0.5">
                           <span className="text-xs opacity-50 uppercase tracking-wider">Dirección Fiscal</span>
                  ...
                  {(identity.terms_url || identity.privacy_url) && (
                      <li className="pt-2 flex gap-4 text-xs underline opacity-70">
                          {identity.terms_url && <a href={identity.terms_url} target="_blank">Términos</a>}
                          {identity.privacy_url && <a href={identity.privacy_url} target="_blank">Privacidad</a>}
                      </li>
                  )}
              </ul>
          </div>
           ...
           <div className="hidden md:flex flex-col items-end justify-between opacity-30">
               ...
               <div className="text-right">
                   <p className="text-xs font-mono">{identity.founding_year ? `Est. ${identity.founding_year}` : ''}</p>
