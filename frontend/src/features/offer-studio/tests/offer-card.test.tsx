...
describe('OfferCard Component', () => {
  ...
  it('respects the pricing currency (PEN) over tenant default', () => {
    const offer: Offer = {
      ...
      currency: 'PEN',
      pricing: [
        { label: 'Standard', total_amount: 1500, currency: 'PEN', deposit_required: 0, number_of_installments: 1, installment_amount: 0 },
      ],
    };
  ...
  it('falls back to tenant currency when pricing has no currency', () => {
    const offer: Offer = {
      ...
      currency: undefined,
      pricing: [
        { label: 'Standard', total_amount: 500, currency: undefined, deposit_required: 0, number_of_installments: 1, installment_amount: 0 },
      ],
    };
    render(<OfferCard offer={offer} />);
    const priceNode = screen.getByText(/PEN/);
