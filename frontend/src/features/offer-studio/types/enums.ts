...
export const OFFER_LIFECYCLE_STATUS = ["draft", "active", "paused", "archived"] as const;
export type OfferLifecycleStatus = (typeof OFFER_LIFECYCLE_STATUS)[number];

export const OFFER_ASSET_TYPE = ["flyer", "video", "carousel", "document", "image"] as const;
...
export const OFFER_ASSET_STATUS = ["draft", "processing", "ready", "error"] as const;
...
export const KNOWLEDGE_SOURCE_STATUS = ["queued", "processing", "indexed", "error"] as const;
export type KnowledgeSourceStatus = (typeof KNOWLEDGE_SOURCE_STATUS)[number];

export const LANDING_JOB_STATUS = ["idle", "queued", "running", "success", "error"] as const;
