import {
  ...
  export const PROGRAM_STRUCTURE_METADATA: Record<ProgramStructure, EnumMetadata> = {
    ...
    [ProgramStructure.MEMBERSHIP]: {
      ...
      description: "Los miembros pagan recurrentemente por acceso continuo a contenido, comunidad y recursos."
    }
  };
  ...
  export const LIVE_INTERACTION_METADATA: Record<LiveInteractionType, EnumMetadata> = {
    ...
    [LiveInteractionType.HOT_SEATS]: {
      ...
      description: "Un alumno presenta su caso y recibe feedback directo mientras los demás aprenden."
    },
  ...
  export const COMMUNITY_PLATFORM_METADATA: Record<CommunityPlatform, EnumMetadata> = {
    ...
    [CommunityPlatform.TELEGRAM]: {
      label: "Telegram",
      description: "Canales y grupos con bots, ideal para comunidades tech o audiencias internacionales."
    },
    [CommunityPlatform.DISCORD]: {
      label: "Discord",
      description: "Servidor de chat con canales temáticos organizados. Ideal para comunidades técnicas."
    },
