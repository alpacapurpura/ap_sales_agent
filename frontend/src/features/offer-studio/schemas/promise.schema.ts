  ...
  fields: [
    {
      ...
      required: true,
      placeholder:
        "ej. Trabaja 60h semanales, se lleva pendientes a casa y siente que no avanza aunque está siempre ocupado.",
    ...
    },
    {
      ...
      required: true,
      placeholder:
        "ej. Delega con confianza, termina la semana a las 6pm y sus reportes toman decisiones sin consultar todo.",
    ...
    },
    {
      ...
      rows: 3,
      placeholder:
        "ej. El mercado laboral premia líderes con equipos autónomos. Cada mes que postergas son oportunidades que el equipo ejecuta sin ti.",
