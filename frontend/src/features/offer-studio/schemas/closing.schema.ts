...
export const offerClosingSchema: SectionSchema = {
  ...
  fields: [
    ...
    },
    {
      ...
      rows: 5,
      placeholder:
        "Si en los próximos 30 días considerás que el programa no cumple con lo prometido, te devolvemos el 100% de tu inversión. Sin preguntas, sin formularios largos. Solo escribinos a soporte@tudominio.com con tu comprobante de compra y procesamos la devolución dentro de las 72 horas hábiles siguientes.",
    ...
    // ─── Urgencia + escasez ───────────────────────────────────────────────
    {
      ...
      rows: 4,
      placeholder:
        "• El precio sube USD 300 el próximo mes (proyección real de ajuste por inflación)\n• Los bonus fast-action vencen el domingo a las 23:59 (hora Perú)\n• La cohorte empieza el 15 de mayo — si no entrás ahora, esperás 3 meses",
      hint: "Uno por línea. Urgencia HONESTA — razones reales, no deadlines falsos. Si no tenés escasez real, no la inventes: suena a infoproductor gringo traducido y pierde confianza.",
    },
    {
      ...
      hint: "Explicá POR QUÉ hay cupos limitados — logística real, tiempo tuyo, calidad de atención. Los compradores Latam sensibilizados detectan escasez fake al instante y se ofenden.",
    },
    {
      id: "bonus_if_act_now",
    ...
    // ─── Último empujón ───────────────────────────────────────────────────
    {
      ...
      rows: 4,
      placeholder:
        "Mirá, entiendo que es una inversión. Y también entiendo que hace meses que venís diciendo 'el próximo mes'. Si seguís esperando, en 6 meses vas a estar en el mismo lugar. El programa tiene garantía incondicional de 30 días — si no te sirve, te devuelvo todo. Pero si te sirve, tu facturación de dentro de 90 días me va a dar la razón. ¿Empezamos?",
      hint: "La frase que el sales-agent usa cuando el lead está a un paso de decidir y necesita un empujón emocional. Tono: directo, empático, con recordatorio de garantía. Evitá guilt-trips o presión manipulativa.",
    },
  ],
};
