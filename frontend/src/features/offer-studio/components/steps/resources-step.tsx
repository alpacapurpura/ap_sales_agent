...
import { OfferFormValues, AssetType } from "../../types/schema";
...
export function ResourcesStep({ form }: StepProps) {
  ...
  const handleFileUpload = (e: React.ChangeEvent<HTMLInputElement>, isKnowledge: boolean) => {
