            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Ej. 90 días" {...field} className="bg-background" />
                  </FormControl>
                </FormItem>
              )}
            />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <RichSelect
                    options={Object.entries(ACCESS_DURATION_METADATA).map(([k, v]) => ({
                      value: k,
                      label: v.label,
...
export function PromiseForm({ defaultValues: propValues, onSave }: PromiseFormProps) {
  ...
  return (
    <SectionFormWrapper<PromiseFormValues>
      ...
      onSubmit={handleSave}
    >
      {(form) => <PromiseContent form={form as unknown as UseFormReturn<OfferFormValues>} />}
    </SectionFormWrapper>
  );
}
