...
function ProgramDetailsContent({ form }: { form: UseFormReturn<OfferFormValues> }) {
  ...
  const recommendedTypes = structureType
    ? STRUCTURE_INTERACTION_RECOMMENDATIONS[structureType]
    : [];

  const filteredInteractionOptions = structureType
    ? allInteractionOptions.filter((opt) =>
        recommendedTypes.includes(opt.value as LiveInteractionType),
      )
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 items-start">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>
                    {structureType === ProgramStructure.CHALLENGE
                      ? "Duración (Días)"
                      : "Duración (Semanas)"}
                  </FormLabel>
                  <FormControl>
              ...
              render={({ field }) => (
                <FormItem className="lg:col-span-1">
                  ...
                  <RichSelect
                    ...
                    placeholder={
                      structureType ? "Selecciona dinámica..." : "Primero elige estructura"
                    }
      ...
      {isCohortOrChallenge && (
        <Card className="border-l-4 border-l-primary/50">
          <CardHeader>
            ...
            <CardDescription>Configura las fechas clave para tu cohorte o reto.</CardDescription>
          </CardHeader>
              ...
              <div className="space-y-6">
                <div className="space-y-2">
                  ...
                  <p className="text-[0.8rem] text-muted-foreground">
                    La hora es opcional (se asume 00:00 si no se define).
                  </p>
                </div>
                    ...
                    <FormItem className="space-y-3 rounded-md border p-3 bg-background">
                      <div className="flex flex-row items-start space-x-3 space-y-0">
                        ...
                        <div className="space-y-1 leading-none">
                          <FormLabel>Definir fecha de Cierre de Inscripciones</FormLabel>
                          <FormDescription>
