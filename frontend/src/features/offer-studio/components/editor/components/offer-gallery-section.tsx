        ...
        <section className="space-y-6 py-4">
            ...
            {!images || images.length === 0 ? (
                <div className="text-center py-8 bg-muted/20 rounded-xl border border-dashed border-border">
                    ...
                    <p className="text-xs text-muted-foreground">Sube assets para usar en landings y anuncios.</p>
                </div>
            ) : (
                        ...
                        <div key={img.id} className="group relative bg-card rounded-xl border border-border overflow-hidden shadow-sm hover:shadow-md transition-all">
                            <div className="relative aspect-video w-full bg-muted">
                                ...
                                <div className="absolute top-2 right-2 flex gap-2">
                                    {img.status === "processing" ? (
                                        ...
                                        <Badge variant="secondary" className="bg-green-100 text-green-800 border-green-200 backdrop-blur-sm text-[10px]">
                            ...
                            <div className="p-3 space-y-2">
                                {img.user_description && (
                                    <div>
                                        <p className="text-[10px] font-semibold text-muted-foreground uppercase tracking-wider mb-0.5">Uso</p>
