      ...
      <CardContent className="pt-6">
        <div className="flex flex-col md:flex-row gap-6 justify-between items-start md:items-center">
           ...
           <div className="flex items-center gap-4 bg-background p-2 rounded-lg border">
              <span className={cn("text-sm", currentMode === "GLOBAL" ? "font-medium text-primary" : "text-muted-foreground")}>
                Heredar Global
              </span>
              <Switch 
              ...
              />
              <span className={cn("text-sm", currentMode === "CUSTOM" ? "font-medium text-primary" : "text-muted-foreground")}>
                Personalizar
              </span>
           </div>
        </div>
