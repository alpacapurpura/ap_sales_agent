      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        <div className="rounded-xl border bg-card/50 p-4 shadow-sm h-full flex flex-col">
          <div className="mb-6 pb-4 border-b">
            ...
            <p className="text-xs text-muted-foreground">
              Primera compra, bajo riesgo. Convierte leads en clientes.
            </p>
          </div>

          <div className="flex-1">{renderLevelGroup(OfferValueLevel.ACTIVACION)}</div>
        </div>
        ...
        <div className="rounded-xl border bg-card/50 p-4 shadow-sm h-full flex flex-col relative overflow-hidden">
          ...
          <div className="mb-6 pb-4 border-b">
            ...
            <p className="text-xs text-muted-foreground">
              Oferta principal, transformacion real. Core offer escalable.
            </p>
          </div>

          <div className="flex-1">{renderLevelGroup(OfferValueLevel.TRANSFORMACION)}</div>
        </div>
        ...
        <div className="rounded-xl border bg-card/50 p-4 shadow-sm h-full flex flex-col">
          ...
          <div className="flex-1">{renderLevelGroup(OfferValueLevel.MAXIMIZACION)}</div>
        </div>
      </div>
        ...
        <div className="flex flex-col md:flex-row gap-8 items-start">
          ...
          <div className="flex-1 w-full">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              {(!groupedOffers[OfferValueLevel.CORPORATIVO] ||
                groupedOffers[OfferValueLevel.CORPORATIVO].length === 0) && (
