...
describe("OfferPreviewSummary", () => {
  it("renders offer name and archetype badge", () => {
    render(
      <OfferPreviewSummary data={FULL_DATA} completenessScore={75} />
    );
  ...
  it("renders value level badge", () => {
    render(
      <OfferPreviewSummary data={FULL_DATA} completenessScore={60} />
    );
  ...
  it("renders price when pricing is available", () => {
    render(
      <OfferPreviewSummary data={FULL_DATA} completenessScore={50} />
    );
  ...
  it("handles empty data gracefully", () => {
    render(
      <OfferPreviewSummary data={EMPTY_DATA} completenessScore={0} />
    );
