    ...
    <section className="py-16 px-6 bg-slate-50">
      <div className="max-w-5xl mx-auto grid md:grid-cols-3 gap-8 text-center md:text-left">
        <div className="space-y-3 p-6 bg-white rounded-xl shadow-sm border border-slate-100">
          ...
          <p className="text-slate-600 text-sm leading-relaxed min-h-[100px]">{problem_text}</p>
        </div>
        <div className="space-y-3 p-6 bg-white rounded-xl shadow-sm border border-slate-100">
          ...
          <p className="text-slate-600 text-sm leading-relaxed min-h-[100px]">{agitation_text}</p>
        </div>
        <div
