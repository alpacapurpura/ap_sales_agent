            ...
            {layout === "urgency" ? (
                ...
                <>
                    ...
                    <Hero.Content>
                        ...
                        {layout === "background" && (
                            <Hero.Tag variant="outline" className="border-white/30 text-white bg-white/10 backdrop-blur-sm">
                                Oferta Exclusiva
                            </Hero.Tag>
                        )}
                        {layout === "split" && (
                            <Hero.Tag variant="secondary" className="bg-slate-100 text-slate-600 hover:bg-slate-200">
                                Nuevo Programa
                            </Hero.Tag>
                        )}
                        {layout === "centered" && (
                    ...
                    {layout === "quiz" ? (
                        ...
                        <Hero.Actions>
                            ...
                            {scarcity_text && (
                                <Hero.Scarcity>{scarcity_text}</Hero.Scarcity>
                            )}
                        </Hero.Actions>
                    )}
                </>
