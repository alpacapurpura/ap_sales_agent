...
export function ManyChatView() {
  ...
  const handleConnect = async () => {
    ...
    try {
        ...
        console.error(error);
        toast.error(error.message || "Error al conectar ManyChat");
    } finally {
        setConnecting(false);
    }
  };
            ...
            <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-1">
                        <Label className="text-muted-foreground text-xs uppercase tracking-wider">Página / Cuenta</Label>
                ...
                <Dialog>
                    ...
                    <DialogContent>
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                Esto eliminará la conexión con ManyChat. El agente dejará de sincronizar datos inmediatamente.
                            </DialogDescription>
                        </DialogHeader>
                        <DialogFooter>
