    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Conecta tu cuenta de WhatsApp para responder automáticamente. Puedes usar el modo QR
            (rápido) o la API Oficial (empresas).
          </CardDescription>
        </CardHeader>
                  ...
                  >
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <h3 className="font-semibold text-sm group-hover:text-green-700 transition-colors">
                            Modo Sincronizado
                          </h3>
                      ...
                      <div className="space-y-3">
                        <ul className="space-y-1.5 text-xs text-muted-foreground">
                          <li className="flex items-center gap-2">
                            <CheckCircle className="h-3 w-3 text-green-500" /> Ideal para Startups
                          </li>
                          <li className="flex items-center gap-2">
                            <CheckCircle className="h-3 w-3 text-green-500" /> Mantienes tu App
                            Móvil
                          </li>
                        </ul>
                        <Button
                  ...
                  <AlertDialog>
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                          Esta acción desconectará el agente de tu WhatsApp. Dejará de responder
                          mensajes automáticamente hasta que vuelvas a escanear el código QR.
                        </AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
              ...
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center gap-3">
                  <div
                    className={cn(
                      "p-2 rounded-lg",
                      metaConnected ? "bg-blue-100 text-blue-600" : "bg-blue-100 text-blue-600",
                    )}
                  >
              ...
              <div className="flex-1">
                {metaConnected ? (
                  ...
                  <div className="space-y-3">
                    <ul className="space-y-1.5 text-xs text-muted-foreground">
                      <li className="flex items-center gap-2">
                        <CheckCircle className="h-3 w-3 text-blue-500" /> Alta Estabilidad
                      </li>
                      <li className="flex items-center gap-2">
                        <AlertTriangle className="h-3 w-3 text-amber-500" /> Requiere Verificación
                      </li>
                    </ul>
        ...
        <CardFooter className="border-t pt-6">
          <div className="flex items-center gap-2 text-xs text-muted-foreground bg-muted/50 p-3 rounded w-full">
            ...
            <p>
              Nota: Puedes tener ambas conexiones configuradas, pero te recomendamos usar solo una
              activa para evitar respuestas duplicadas.
            </p>
          </div>
        </CardFooter>
      </Card>
