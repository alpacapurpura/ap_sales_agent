    ...
    <div className="space-y-6">
        <Card>
            <CardHeader>
                ...
                <CardDescription>
                    Tu agente está sincronizado con esta tienda de Shopify.
                </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-1">
                        <Label className="text-muted-foreground text-xs uppercase tracking-wider">URL de la Tienda</Label>
                        <p className="font-medium text-lg flex items-center gap-2">
                            {status.shop_url || "Desconocido"}
                            {status.shop_url && (
                                <a href={`https://${status.shop_url}`} target="_blank" rel="noreferrer" className="text-blue-500 hover:underline">
                    ...
                    <div className="space-y-1">
                        <Label className="text-muted-foreground text-xs uppercase tracking-wider">Scope</Label>
                ...
                <Dialog>
                    ...
                    <DialogContent>
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                Esto eliminará la conexión con Shopify. El agente dejará de sincronizar datos inmediatamente.
                            </DialogDescription>
                        </DialogHeader>
                        <DialogFooter>
