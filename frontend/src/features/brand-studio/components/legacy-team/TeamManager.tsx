...
/**
 * LEGACY TeamManager adapter.
 *
 * Bridges offer-studio's ``InstructorsSelector`` to brand-studio without
 * blocking Sprint 5's ``features/brand/`` deletion. Same behavior as the
 * original brand/sections/team/team-manager.tsx; imports rewired to
 * brand-studio. Delete when Sprint 6 migrates offer-studio editor to
 * route-per-field form-runtime — at that point InstructorsSelector will
 * either link to ``/brand-studio/team`` or render the team SectionPage
 * directly.
 */
  ...
  return (
    <div className="space-y-8">
      <Card className="w-full min-h-[600px]">
        ...
        <CardContent>
          <TeamList team={team} onEdit={openTeamModal} onDelete={handleDeleteMember} />
        </CardContent>
      </Card>
