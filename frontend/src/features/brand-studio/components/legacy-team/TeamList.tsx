...
/**
 * LEGACY team-list. Ported verbatim from features/brand/sections/team/team-list.tsx
 * with imports rewired to brand-studio. Dies with the rest of legacy-team/
