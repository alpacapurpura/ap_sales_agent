...
export const testimonialItemSchema: SectionSchema = {
  ...
  fields: [
    // ── Autor ────────────────────────────────────────────────────
    {
      ...
      hint: "Nombre real o iniciales del cliente. Testimonios con nombre completo generan más confianza que los anónimos.",
      group: "Autor",
        ...
        fields: [
          {
            ...
            path: "value",
            required: true,
            hint: "Etiqueta corta para clasificar el testimonio (ej. 'resultado rápido', 'mujer 35+', 'B2B').",
          },
        ],
      },
    },
