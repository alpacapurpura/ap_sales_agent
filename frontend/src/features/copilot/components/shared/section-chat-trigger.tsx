 ...
 */
export const SectionChatTrigger = forwardRef<HTMLButtonElement, SectionChatTriggerProps>(
  ({ sectionId, sectionLabel, className, ...props }, ref) => {
    ...
    return (
      <Button
        ...
        className={cn("h-7 w-7 text-muted-foreground hover:text-purple-400", className)}
        {...props}
      >
