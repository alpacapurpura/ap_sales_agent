...
const ROUTE_SUGGESTIONS: Record<string, SuggestedAction[]> = {
  "brand-studio": [
    {
      label: "¿Qué me falta de mi marca?",
    ...
    {
      label: "Extrae mi marca de mi web",
  ...
  sales: [
    ...
    {
      label: "¿Quiénes son mis mejores leads?",
  ...
  connections: [
    {
      label: "¿Qué debo conectar primero?",
