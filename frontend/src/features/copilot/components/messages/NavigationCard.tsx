...
export function NavigationCard({ action }: NavigationCardProps) {
  ...
  return (
    <Button
      variant="outline"
      onClick={handleClick}
      className="my-1 flex h-auto w-full max-w-full items-center justify-between gap-2 overflow-hidden rounded-xl border-purple-200 bg-purple-50/50 px-3 py-2.5 text-left text-sm hover:bg-purple-100 dark:border-purple-800 dark:bg-purple-900/20 dark:hover:bg-purple-900/40"
    >
