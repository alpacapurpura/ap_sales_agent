        ...
        <TooltipTrigger asChild>
          <button
            ...
            className={cn(
              ...
              variant === 'disconnected' && 'bg-muted/60 text-muted-foreground border-border/50 opacity-60 hover:opacity-90 hover:bg-muted',
          ...
          >
            ...
            {variant === 'no-data' && (
              <AlertTriangle data-testid="alert-icon" className="w-3 h-3 shrink-0" aria-hidden="true" />
            )}
          </button>
        </TooltipTrigger>
        <TooltipContent>
