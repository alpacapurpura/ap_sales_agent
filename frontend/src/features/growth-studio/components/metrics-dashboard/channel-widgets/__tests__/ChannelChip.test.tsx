...
describe('ChannelChip', () => {
  ...
  describe('variant: disconnected', () => {
    ...
    it('has aria-label for accessibility', () => {
      render(<ChannelChip channel={disconnectedChannel} variant="disconnected" />);
      expect(screen.getByRole('button', { name: /TikTok Organic.*desconectado/i })).toBeInTheDocument();
    });
  ...
  describe('variant: no-data', () => {
    ...
    it('shows no-data tooltip text', () => {
      render(<ChannelChip channel={noDataChannel} variant="no-data" />);
      expect(screen.getByText('Conectado pero sin datos, ¡revisemos cómo podemos usarlo!')).toBeInTheDocument();
    });

    it('has aria-label for accessibility', () => {
      render(<ChannelChip channel={noDataChannel} variant="no-data" />);
      expect(screen.getByRole('button', { name: /Google Analytics.*sin datos/i })).toBeInTheDocument();
    });
