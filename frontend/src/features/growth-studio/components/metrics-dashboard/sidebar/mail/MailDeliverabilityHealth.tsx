...
function computeHealthLevel(kpis: MetricKpiData[]): { level: HealthLevel; score: number; details: string } {
...
const HEALTH_CONFIG: Record<HealthLevel, { icon: typeof ShieldCheck; label: string; color: string; bg: string; border: string }> = {
  healthy: {
    icon: ShieldCheck,
    label: 'Saludable',
