...
interface MailHeroKpiGridProps {
  kpis: MetricKpiData[];
...
export function MailHeroKpiGrid({ kpis, timeSeries }: MailHeroKpiGridProps) {
                ...
                >
                  <AreaChart data={sparkData}>
                    ...
                    <Area
                      ...
                      stroke="var(--color-v)"
                      strokeWidth={1.5}
                      fill={`url(#mail-grad-${kpi.metricName})`}
                    />
                  </AreaChart>
                </ChartContainer>
              )}
