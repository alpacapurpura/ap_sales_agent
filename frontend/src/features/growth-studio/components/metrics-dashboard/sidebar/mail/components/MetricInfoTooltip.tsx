      ...
      <Tooltip>
        ...
        <TooltipContent side={side} className="max-w-[260px] p-3">
          <div className="space-y-1.5">
            ...
            {info.interpret &&
              (info.interpret.good || info.interpret.mid || info.interpret.bad) && (
                <div className="text-[10px] border-t border-border pt-1.5 space-y-0.5">
                  ...
                  {info.interpret.mid && (
                    <p>
                      <span className="font-semibold text-amber-500">~</span> {info.interpret.mid}
                    </p>
                  )}
                  {info.interpret.bad && (
                    <p>
                      <span className="font-semibold text-red-500">✗</span> {info.interpret.bad}
                    </p>
                  )}
                </div>
              )}
