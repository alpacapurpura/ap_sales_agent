...
export type MetaAdsMiniFunnelFilter =
  | 'all'
  | 'offer'
  | 'branding'
  | 'unassigned';
...
const EMPTY_COPY: Record<MetaAdsMiniFunnelFilter, string> = {
  ...
  offer:
    'Esta offer aún no tiene campañas asignadas o no reportó eventos en el período.',
