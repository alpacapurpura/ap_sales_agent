...
const MOCK_DATA: ChannelDashboardData = {
  ...
  kpis: [
    ...
    {
      metricName: "watch_time_minutes",
      displayName: "Minutos Vistos",
      currentValue: 8500,
      previousValue: 7200,
      deltaPct: 18.1,
      deltaAbsolute: 1300,
    ...
    },
    {
      ...
      displayName: "Suscriptores Ganados",
      currentValue: 340,
      previousValue: 280,
      deltaPct: 21.4,
      deltaAbsolute: 60,
    ...
    {
      metricName: "avg_view_percentage",
      displayName: "% Retenci\u00f3n Promedio",
      currentValue: 52.3,
      previousValue: 48.1,
      deltaPct: 8.7,
      deltaAbsolute: 4.2,
