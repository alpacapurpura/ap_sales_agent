...
interface YouTubeHeroKpiGridProps {
  kpis: MetricKpiData[];
...
export function YouTubeHeroKpiGrid({ kpis, timeSeries }: YouTubeHeroKpiGridProps) {
                ...
                >
                  <AreaChart data={sparkData}>
                    ...
                    <Area
                      ...
                      stroke="var(--color-v)"
                      strokeWidth={1.5}
                      fill={`url(#yt-grad-${kpi.metricName})`}
                    />
                  </AreaChart>
                </ChartContainer>
              )}
