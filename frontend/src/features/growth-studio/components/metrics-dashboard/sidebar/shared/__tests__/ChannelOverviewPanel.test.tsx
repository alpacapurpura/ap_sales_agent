...
const MOCK_IG_DATA: ChannelDashboardData = {
  ...
  kpis: [
    ...
    {
      metricName: "ig_follows_and_unfollows",
      displayName: "Seguidores netos",
      currentValue: 127,
      previousValue: 95,
      deltaPct: 33.7,
      deltaAbsolute: 32,
    ...
    },
    {
      ...
      benchmark: {
        ...
        high: 0.8,
        unit: "percentage",
        interpretation: "Tasa de interacción",
      },
    },
  ],
  timeSeries: [],
...
describe("ChannelOverviewPanel", () => {
  ...
  it("renders the funnel section", () => {
    ...
    expect(screen.getByRole("list", { name: /embudo de conversión/i })).toBeInTheDocument();
  });
