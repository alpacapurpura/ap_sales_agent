...
const KPIS: MetricKpiData[] = [
  { ...BASE_KPI, metricName: 'metric_a', displayName: 'Metric A', currentValue: 2450, unit: 'count' },
  { ...BASE_KPI, metricName: 'metric_b', displayName: 'Metric B', currentValue: 485000, unit: 'count' },
  { ...BASE_KPI, metricName: 'metric_c', displayName: 'Metric C', currentValue: 127, unit: 'count' },
  { ...BASE_KPI, metricName: 'metric_d', displayName: 'Metric D', currentValue: 0.51, unit: 'percentage' },
];
...
describe('HeroKpiGrid', () => {
  ...
  it('applies red trend color for negative delta', () => {
    const negativeKpis: MetricKpiData[] = [
      { ...BASE_KPI, metricName: 'metric_a', displayName: 'Metric A', currentValue: 90, unit: 'count', deltaPct: -5.0, deltaAbsolute: -10 },
    ];
    render(
      <HeroKpiGrid
        kpis={negativeKpis}
    ...
    const kpiWithBenchmark: MetricKpiData[] = [
      {
        ...
        currentValue: 0.9,
        unit: 'percentage',
        benchmark: { low: 0.3, median: 0.5, high: 0.8, unit: 'percentage', interpretation: 'Test benchmark' },
      },
    ];
    const { container } = render(
      <HeroKpiGrid
