...
const MOCK_WEBSITE_DATA: ChannelDashboardData = {
  ...
  period: '30d',
  kpis: [
    { metricName: 'sessions', displayName: 'Sesiones', currentValue: 12500, previousValue: 10200, deltaPct: 22.5, deltaAbsolute: 2300, unit: 'count', higherIsBetter: true, benchmark: null },
    { metricName: 'engagementRate', displayName: 'Engagement Rate', currentValue: 0.65, previousValue: 0.58, deltaPct: 12.1, deltaAbsolute: 0.07, unit: 'percentage', higherIsBetter: true, benchmark: null },
    { metricName: 'bounceRate', displayName: 'Tasa de Rebote', currentValue: 0.35, previousValue: 0.42, deltaPct: -16.7, deltaAbsolute: -0.07, unit: 'percentage', higherIsBetter: false, benchmark: null },
    { metricName: 'conversions', displayName: 'Conversiones', currentValue: 340, previousValue: 280, deltaPct: 21.4, deltaAbsolute: 60, unit: 'count', higherIsBetter: true, benchmark: null },
    { metricName: 'averageSessionDuration', displayName: 'Duración Promedio', currentValue: 185, previousValue: 160, deltaPct: 15.6, deltaAbsolute: 25, unit: 'seconds', higherIsBetter: true, benchmark: null },
    { metricName: 'users', displayName: 'Usuarios', currentValue: 9800, previousValue: 8100, deltaPct: 21.0, deltaAbsolute: 1700, unit: 'count', higherIsBetter: true, benchmark: null },
  ],
  timeSeries: [],
  funnel: {
    steps: [
