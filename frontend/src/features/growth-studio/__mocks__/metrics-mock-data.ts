      ...
      },
      {
        ...
        metrics: [
          { name: "reach", value: 4000 },
          {
            name: "engagement",
            value: 800,
            breakdown: { reactions: 500, comments: 200, shares: 100 },
          },
        ],
...
export const MOCK_NURTURE_DETAIL: NurtureDetail = {
  headerKpis: { totalMqls: 2100, conversionRate: 24.7, costPerMql: 12.5 },
  miniFunnel: {
    sourceLabel: "Leads",
    sourceValue: 8500,
    targetLabel: "MQLs",
    ...
    channels: [
      {
        ...
        metrics: [
          { name: "count", value: 38 },
          { name: "value", value: 12450.0, unit: "currency", currency: "USD" },
        ],
      },
      {
        slug: "abandoned-cart",
        ...
        metrics: [
          { name: "count", value: 14 },
          { name: "value", value: 4200.0, unit: "currency", currency: "USD" },
          { name: "abandonment_rate", value: 36.8 },
        ],
      },
    ],
    totals: { count: 38, abandoned: 14, value: 12450.0, abandonment_rate: 36.8 },
  },
  paymentLinks: {
    channels: [
      {
...
export const MOCK_ADOPTION_DETAIL: AdoptionDetail = {
  ...
  offers: [
    {
      offerId: "offer-1",
      publicName: "Curso de Marketing Digital",
      totalCustomers: 95,
      activeCount: 78,
      inactiveCount: 17,
      healthPct: 82.1,
...
export const MOCK_EXPANSION_DETAIL: ExpansionDetailData = {
  ...
  retencion: {
    groupKey: "retencion",
    groupLabel: "Retencion",
    groupSubtitle: "Renovaciones de suscripciones activas",
    totalCount: 45,
    totalRevenue: 38000,
    totalRevenueUsd: 2204,
    currency: "MXN",
    ratePct: 92.0,
    offers: [
      {
      ...
      {
        offerId: "offer-4",
        publicName: "Plan Coaching Mensual",
        count: 15,
        revenue: 9500,
        currency: "MXN",
        usdRevenue: 551,
  ...
  crecimiento: {
    groupKey: "crecimiento",
    groupLabel: "Crecimiento",
    groupSubtitle: "Ventas adicionales y upgrades a clientes existentes",
    totalCount: 12,
    totalRevenue: 15000,
    totalRevenueUsd: 870,
    currency: "MXN",
    ...
    offers: [
      ...
      {
        offerId: "offer-6",
        publicName: "Consultoria Express",
        count: 4,
        revenue: 3000,
        currency: "MXN",
        usdRevenue: 174,
  ...
  cancelaciones: {
    groupKey: "cancelaciones",
    groupLabel: "Cancelaciones",
    groupSubtitle: "Suscripciones perdidas y ingreso afectado",
    totalCount: 5,
    totalRevenue: 8000,
    totalRevenueUsd: 464,
    currency: "MXN",
...
export const MOCK_EVANGELIZATION_DETAIL: EvangelizationDetail = {
  ...
  miniFunnel: {
    sourceLabel: "Clientes Activos",
    sourceValue: 42,
    targetLabel: "Evangelistas",
    targetValue: 5,
    conversionRate: 11.9,
  },
  referidos: [
    ...
    },
    {
      ...
      referralCode: "REF-CL9B7Z",
      referralsSent: 4,
      conversions: 2,
      revenueAttributed: 8000,
      currency: "MXN",
      usdRevenue: 444,
      isActive: true,
    },
    {
      customerId: "mock-3",
      fullName: "Ana Torres",
      referralCode: "REF-AT3F1Q",
      referralsSent: 3,
      conversions: 1,
      revenueAttributed: 4000,
      currency: "MXN",
      usdRevenue: 222,
      isActive: true,
    },
  ...
  candidatos: [
    {
      ...
      npsScore: 10,
      respondedAt: "2026-03-10T14:30:00Z",
    },
    {
      customerId: "mock-5",
      fullName: "Laura Mendez",
      npsScore: 9,
      respondedAt: "2026-03-12T09:15:00Z",
    },
  ],
  npsSummary: {
    npsScore: 8.4,
