  ...
  organicSocial: {
    ...
    channels: [
      ...
      },
      {
        ...
        channelType: 'social',
        metrics: [
          { name: 'views', value: 45200 },
          { name: 'engagement', value: 2850, breakdown: { likes: 2100, dislikes: 45 } },
          { name: 'subscribers_gained', value: 380 },
          { name: 'watch_time_minutes', value: 128500 },
          { name: 'avg_view_duration', value: 245 },
          { name: 'avg_view_percentage', value: 42.3, unit: 'percentage' },
          { name: 'comments', value: 340 },
          { name: 'shares', value: 185 },
          { name: 'subscribers_lost', value: 28 },
          { name: 'card_clicks', value: 250 },
          { name: 'card_impressions', value: 5000 },
          { name: 'card_click_rate', value: 5.0, unit: 'percentage' },
          { name: 'end_screen_clicks', value: 180 },
          { name: 'end_screen_impressions', value: 3000 },
          { name: 'end_screen_click_rate', value: 6.0, unit: 'percentage' },
        ],
        sourceLabel: 'YouTube',
        connected: true,
      },
