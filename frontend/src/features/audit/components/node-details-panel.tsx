    ...
    <Sheet open={isOpen} onOpenChange={onOpenChange}>
      <SheetContent side="right" className="w-[400px] sm:w-[540px] flex flex-col p-0 gap-0">
        <SheetHeader className="px-6 py-4 border-b">
          ...
          <SheetDescription>Información de ejecución del paso seleccionado</SheetDescription>
        </SheetHeader>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4 bg-muted/30 p-4 rounded-lg border">
                  ...
                  <div>
                    ...
                    <div className="text-xs font-mono truncate" title={trace.id}>
                      {trace.id}
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
                    ...
                    <div className="text-sm font-mono">
                      {Number(trace.execution_time_ms || 0).toFixed(0)}ms
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
                        ...
                        <div key={log.id} className="border rounded-lg p-3 bg-card space-y-3">
                          <div className="flex justify-between items-center text-xs text-muted-foreground">
                            ...
                            <span className="font-mono">
                              {log.tokens_input} &rarr; {log.tokens_output}
                            </span>
                          </div>
