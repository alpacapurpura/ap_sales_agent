            ...
            <Dialog open={deleteOpen} onOpenChange={setDeleteOpen}>
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Esta acción eliminará permanentemente todos los mensajes, trazas y memoria de
                    este lead. El lead volverá al inicio del funnel.
                    <br />
                    <br />
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <div className="text-sm font-mono truncate" title={lead.id}>
                          {lead.id}
                        </div>
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <div className="flex gap-1 flex-wrap">
                          ...
                          {lead.whatsapp_id && (
                            <span className="text-[10px] bg-green-100 text-green-800 px-1.5 rounded">
                              WA
                            </span>
                          )}
                        </div>
                ...
                {loadingTrace ? (
                  ...
                  <div className="text-muted-foreground text-center py-8">
                    ...
                    <p className="text-xs mt-2">
                      El estado se genera cuando el agente ejecuta nodos.
                    </p>
                  </div>
                )}
              </div>
