...
/**
 * Debounced autosave hook. Returns a state machine (idle → saving → saved | error)
 * plus trigger/retry/cancel controls. Used by the form-runtime AutosaveBanner
 * and by offer-studio's section editor (via compat shim at features/offer-studio/hooks/use-auto-save.ts).
 */
