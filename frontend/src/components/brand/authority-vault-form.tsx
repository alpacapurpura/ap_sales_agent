                    ...
                    {vault.map(item => (
                        <div key={item.id} className="flex items-start justify-between p-4 border rounded-lg hover:bg-muted/50 transition-colors">
                            ...
                            <div className="flex space-x-2">
                                ...
                                <Button variant="ghost" size="icon" onClick={() => openVaultModal(item)}>
                                    <Edit2 className="h-4 w-4" />
                                </Button>
                                <Button variant="ghost" size="icon" className="text-destructive hover:text-destructive" onClick={() => deleteVaultItem(item.id)}>
