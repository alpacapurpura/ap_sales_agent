...
export const BrandIcon = ({
  ...
  if (normalizedValue.includes("facebook") || normalizedValue === "fb")
  ...
  if (normalizedValue.includes("whatsapp") || normalizedValue === "wa")
    return <SiWhatsapp className={className} />;
  if (normalizedValue.includes("youtube") || normalizedValue === "yt")
  ...
  if (normalizedValue.includes("google") || normalizedValue === "ga4")
