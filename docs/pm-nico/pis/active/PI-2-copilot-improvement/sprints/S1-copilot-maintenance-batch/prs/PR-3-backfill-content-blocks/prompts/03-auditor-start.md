...
**Lectura obligatoria:**
1. `docs/pm-nico/pis/active/PI-2-copilot-improvement/sprints/S1-*/prs/PR-3-backfill-content-blocks/PR.md`
2. `docs/pm-nico/pis/active/PI-2-copilot-improvement/sprints/S1-*/prs/PR-3-backfill-content-blocks/CONTRACT.md`
3. `docs/pm-nico/pis/active/PI-2-copilot-improvement/sprints/S1-*/prs/PR-3-backfill-content-blocks/IMPL-LOG.md`
...
**Tu output:**
- PR backend-only o frontend-only → `docs/pm-nico/pis/active/PI-2-copilot-improvement/sprints/S1-*/prs/PR-3-backfill-content-blocks/REVIEW.md`
...
2. Última línea respuesta:
   `<!-- @pm: REVIEW{,-backend,-frontend}.md ready (PASS|WARN|FAIL). Próximo paso: ejecutar prompts/04-pm-close.md o ejecutar /pm "PR-3 auditor done" para cerrar loop. -->`
