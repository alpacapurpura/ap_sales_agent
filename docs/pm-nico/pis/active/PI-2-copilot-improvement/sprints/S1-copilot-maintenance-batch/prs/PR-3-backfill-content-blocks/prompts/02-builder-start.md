...
1. `docs/pm-nico/pis/active/PI-2-copilot-improvement/sprints/S1-*/prs/PR-3-backfill-content-blocks/PR.md` — problema + scope
2. `docs/pm-nico/pis/active/PI-2-copilot-improvement/sprints/S1-*/prs/PR-3-backfill-content-blocks/CONTRACT.md` — schemas + interfaces (SSoT pre-implementación)
3. `docs/pm-nico/current-state/copilot.md` — capacidades vivas (no duplicar)
4. `.claude/rules/backend-ddd.md` + `.claude/rules/backend-migrations.md` + `.claude/rules/tenant-isolation.md` + `.claude/rules/tdd-mandatory.md` + `.claude/rules/copilot-resilience.md`
5. `CLAUDE.md` (root)
...
- `docs/pm-nico/pis/active/PI-2-copilot-improvement/sprints/S1-*/prs/PR-3-backfill-content-blocks/IMPL-LOG.md` siguiendo template
