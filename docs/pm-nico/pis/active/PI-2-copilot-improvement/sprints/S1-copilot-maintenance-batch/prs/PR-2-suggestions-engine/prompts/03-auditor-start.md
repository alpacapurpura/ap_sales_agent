...
**Lectura obligatoria:**
1. `docs/pm-nico/pis/active/PI-2-copilot-improvement/sprints/S1-*/prs/PR-2-suggestions-engine/PR.md`
2. `docs/pm-nico/pis/active/PI-2-copilot-improvement/sprints/S1-*/prs/PR-2-suggestions-engine/CONTRACT.md`
3. `docs/pm-nico/pis/active/PI-2-copilot-improvement/sprints/S1-*/prs/PR-2-suggestions-engine/IMPL-LOG.md`
...
**Tu output:**
- PR backend-only o frontend-only → `docs/pm-nico/pis/active/PI-2-copilot-improvement/sprints/S1-*/prs/PR-2-suggestions-engine/REVIEW.md`
...
2. Última línea respuesta:
   `<!-- @pm: REVIEW{,-backend,-frontend}.md ready (PASS|WARN|FAIL). Próximo paso: ejecutar prompts/04-pm-close.md o ejecutar /pm "PR-2 auditor done" para cerrar loop. -->`
