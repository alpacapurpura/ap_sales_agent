...
PR-{n}-{slug} terminó implementación + auditoría. Cierro el loop.

Lee:
- `docs/pm-nico/pis/active/PI-{X}-{theme}/sprints/S{N}-*/prs/PR-{n}-{slug}/IMPL-LOG.md`
- `docs/pm-nico/pis/active/PI-{X}-{theme}/sprints/S{N}-*/prs/PR-{n}-{slug}/REVIEW.md`
...
2. Update `current-state/{módulo}.md` con bloque "Capacidades" copiado de RESULT.md.
3. Append decisiones relevantes a `pis/active/PI-{X}-{theme}/decisions.md`.
4. Append learnings de este PR a `sprints/S{N}-*/learnings.md`.
