...
```
Agent({
  description: "Pre-flight PR-1 telegram-bot-foundation",
...
<pr_folder>: /home/chris/AISALESHT/docs/pm-nico/pis/active/PI-5-copilot-multicanal-telegram/sprints/S1-foundation-telegram-bot/prs/PR-1-telegram-bot-foundation
<modules>: copilot, shared, core, frontend
<phase>: architect
<subsystem_keywords>: telegram, webhook, bot, hmac, magic_link, channel_link, arq, queue, channel_format, sanitize_payload
