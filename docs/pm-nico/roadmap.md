...
|---|---|---|---|
| **Backend Quality Guardrails** (fix 10+ tests rotos + cobertura P0/P1 + arch fitness) | **PI-11** | **alta prioridad** — Chris quiere Opus luego, no ahora. Puede subir a Now cuando PI-5 S3 cierre. | [pis/active/PI-11-backend-quality-guardrails/PI.md](pis/active/PI-11-backend-quality-guardrails/PI.md) |
