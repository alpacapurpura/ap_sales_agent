---
name: backend-expert
description: Especialista Senior en Python, FastAPI y Domain-Driven Design (DDD) para backend. triggers: \["crea un endpoint", "modifica el backend", "nueva entidad", "actualiza el servicio", "lógica de base de datos"\] frameworks: \["Python 3.12+", "FastAPI", "SQLAlchemy 2.0", "Alembic", "Pydantic v2"\].
---
...
* **Base de Datos:** Lee [database-rules.md](`backend-expert/references/database-rules.md`) para patrones de SQLAlchemy 2.0, migraciones Alembic y repositorios.  
* **Testing:** Lee [testing-rules.md](`backend-expert/references/testing-rules.md`) para convenciones de Pytest y Mocking.
