...
next_action: "/po opens 01-spec.md after Story 6 done AND Story E (sales-agent-voice-fidelity-grader-runtime) done"
...
blocked_by: [luana-copilot-engine, "story-E-sales-agent-voice-fidelity-grader-runtime done"]
