...
story_ids:
  ...
  - sales-agent-voice-fidelity-grader-runtime    # → role E: MAJ-EVAL voice fidelity grader DONE 2026-05-11 (archived; 10/10 tickets GREEN + auditor-agentic APPROVED Conv 3 iter 1 + capability sales-eval-multi-judge-grader live + 5 scenarios cement + 12 cardinal decisions honored. Unblocks luana-platform Story 7 luana-sales-agent-engine lift. Stories F+G+H+I deferred to post-luana-Story-7 build per Chris scope A 2026-05-10 — avoid re-lift double work)
