...
story_ids:
  - app-shell-sidebar-copilot-decoupling
  - growth-studio-folder-parity                    # 2A — split 2026-05-07 (was: growth-studio-architectural-parity)
  - growth-studio-actions-schemas-real             # 2B — split 2026-05-07 (sequential after 2A)
